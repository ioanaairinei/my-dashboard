...
const DetailsView = ({title, author, img, location, locationUrl, onClose}: DetailsViewProps) => {
            ...
            <div className="content-details-view">
                ...
                <div className="description">
                    ...
                    <div className="description-links">
                        Can be admired in <a href={locationUrl} target="_blank">{location}</a>
                    </div>
                </div>
                }
            </div>
